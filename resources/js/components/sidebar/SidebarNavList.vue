<template>
	...
	<li v-if="menu.children" class="has-sub" v-bind:class="{ 'active': subIsActive(menu.path) }">
      ...
      <sidebar-nav-list v-for="submenu in menu.children" v-bind:menu="submenu" v-bind:key="submenu.path" ref="sidebarNavList" v-on:collapse-other="handleCollapseOther(submenu)"></sidebar-nav-list>
		</ul>
	</li>
