<template>
	<div>
			...
			<div class="login-content">
				<form v-on:submit="checkForm" method="POST" class="margin-bottom-0">
					<div class="form-group m-b-20">
						<input type="text" class="form-control form-control-lg" placeholder="Provide Login" required />
					</div>

					<div class="login-buttons">
						<button type="submit" class="btn btn-primary btn-block btn-lg">Check</button>
					</div>
					<!--<div class="m-t-20">
		...
		<ul class="login-bg-list clearfix">
            <li v-bind:class="{ 'active': bg.bg1.active }"><a href="javascript:;" v-on:click="select('bg1')" style="background-image: url(/images/login-bg/login-bg-16.jpg)"></a></li>
            <li v-bind:class="{ 'active': bg.bg2.active }"><a href="javascript:;" v-on:click="select('bg2')" style="background-image: url(/images/login-bg/login-bg-17.jpg)"></a></li>
			<li v-bind:class="{ 'active': bg.bg3.active }"><a href="javascript:;" v-on:click="select('bg3')" style="background-image: url(/images/login-bg/login-bg-15.jpg)"></a></li>
			<li v-bind:class="{ 'active': bg.bg4.active }"><a href="javascript:;" v-on:click="select('bg4')" style="background-image: url(/images/login-bg/login-bg-14.jpg)"></a></li>
			<li v-bind:class="{ 'active': bg.bg5.active }"><a href="javascript:;" v-on:click="select('bg5')" style="background-image: url(/images/login-bg/login-bg-13.jpg)"></a></li>
			<li v-bind:class="{ 'active': bg.bg6.active }"><a href="javascript:;" v-on:click="select('bg6')" style="background-image: url(/images/login-bg/login-bg-12.jpg)"></a></li>
		</ul>
		<!-- end login-bg -->
	</div>
</template>
