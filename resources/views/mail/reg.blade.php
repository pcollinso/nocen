...
<body width="100%" bgcolor="#222222" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; background: #222222;">
        ...
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
            Veripay Suite Email Notification, Thanks for your patronage.
        </div>
        ...
        <div style="max-width: 600px; margin: auto;">
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <img src="<?php echo $message->embed($pathToFile); ?>" width="300" height="100" alt="alt_text" border="0" align="left" style="width: 300px;height: 100px" >
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-family: Verdana, Arial, sans-serif; font-size: 15px; line-height: 20px; color: #0a6aa1;letter-spacing:1px">
                                    Hi #NAME,
                                    <br><br>
                                    Welcome to Veripay
                                    <br><br>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
                <tr>
                    <td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; line-height:18px; text-align: center; color: #888888;">
                        ...
                        <br><br>
                        AppmartGroup Integrated Limited<br><span class="mobile-link--footer">4th floor, Churchgate towers, Constitution Avenue, Central Business District Abuja</span><br><span class="mobile-link--footer">09-6233402</span>
                        <br><br>
