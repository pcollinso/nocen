...
@section('content')
  ...
  <!-- begin content-bg -->
  <div class="content-bg" style="background-image: url(/assets_front/img/bg/bg-home.jpg);"
    data-paroller="true"
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-12">
        ...
        <div class="about-author">
          ...
          <div class="author">
            <div class="image">
              <img src="/assets_front/img/user/user-1.jpg" alt="Sean Ngu" />
            </div>
            <div class="info">
              Sean Ngu
  ...
  <!-- begin content-bg -->
  <div class="content-bg" style="background-image: url(/assets_front/img/bg/bg-milestone.jpg)"
    data-paroller="true"
    data-paroller-factor="0.5"
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-12">
        ...
        <div class="team">
          <div class="image" data-animation="true" data-animation-type="flipInX">
            <img src="/assets_front/img/user/user-1.jpg" alt="Ryan Teller" />
          </div>
          <div class="info">
      ...
      <div class="col-md-4 col-sm-12">
        ...
        <div class="team">
          <div class="image" data-animation="true" data-animation-type="flipInX">
            <img src="/assets_front/img/user/user-2.jpg" alt="Jonny Cash" />
          </div>
          <div class="info">
      ...
      <div class="col-md-4 col-sm-12">
        ...
        <div class="team">
          <div class="image" data-animation="true" data-animation-type="flipInX">
            <img src="/assets_front/img/user/user-3.jpg" alt="Mia Donovan" />
          </div>
          <div class="info">
  ...
  <!-- begin content-bg -->
  <div class="content-bg" style="background-image: url(/assets_front/img/bg/bg-quote.jpg)"
    data-paroller-factor="0.5"
    data-paroller-factor-md="0.01"
  ...
  <!-- begin content-bg -->
  <div class="content-bg" style="background-image: url(/assets_front/img/bg/bg-action.jpg)"
    data-paroller-factor="0.5"
    data-paroller-factor-md="0.01"
    data-paroller-factor-xs="0.01">
  </div>
  ...
  <div class="container" data-animation="true" data-animation-type="fadeInDown">
    ...
    <div class="row row-space-10">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="work">
          <div class="image">
            <a href="#"><img src="/assets_front/img/work/work-img-1.jpg" alt="Work 1" /></a>
          </div>
          <div class="desc">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="work">
          <div class="image">
            <a href="#"><img src="/assets_front/img/work/work-img-2.jpg" alt="Work 2" /></a>
          </div>
          <div class="desc">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="work">
          <div class="image">
            <a href="#"><img src="/assets_front/img/work/work-img-3.jpg" alt="Work 3" /></a>
          </div>
          <div class="desc">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="work">
          <div class="image">
            <a href="#"><img src="/assets_front/img/work/work-img-4.jpg" alt="Work 4" /></a>
          </div>
          <div class="desc">
    ...
    <div class="row row-space-10">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="work">
          <div class="image">
            <a href="#"><img src="/assets_front/img/work/work-img-5.jpg" alt="Work 5" /></a>
          </div>
          <div class="desc">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="work">
          <div class="image">
            <a href="#"><img src="/assets_front/img/work/work-img-6.jpg" alt="Work 6" /></a>
          </div>
          <div class="desc">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="work">
          <div class="image">
            <a href="#"><img src="/assets_front/img/work/work-img-7.jpg" alt="Work 7" /></a>
          </div>
          <div class="desc">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div class="work">
          <div class="image">
            <a href="#"><img src="/assets_front/img/work/work-img-8.jpg" alt="Work 8" /></a>
          </div>
          <div class="desc">
  ...
  <!-- begin content-bg -->
  <div class="content-bg" style="background-image: url(/assets_front/img/bg/bg-client.jpg)"
    data-paroller-factor="0.5"
    data-paroller-factor-md="0.01"
    data-paroller-factor-xs="0.01">
  </div>
