...
class CreateApplicationQualfTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sch_application_qualf', function (Blueprint $table) {
            ...
            $table->integer('sub1')->unsigned()->nullable()->index();
            $table->integer('sub2')->unsigned()->nullable()->index();
            $table->integer('sub3')->unsigned()->nullable()->index();
            $table->integer('sub4')->unsigned()->nullable()->index();
            $table->integer('sub5')->unsigned()->nullable()->index();
            $table->integer('sub6')->unsigned()->nullable()->index();
            $table->integer('sub7')->unsigned()->nullable()->index();
            $table->integer('sub8')->unsigned()->nullable()->index();
            $table->integer('sub9')->unsigned()->nullable()->index();
            $table->integer('gd1')->unsigned()->nullable()->index();
            $table->integer('gd2')->unsigned()->nullable()->index();
            $table->integer('gd3')->unsigned()->nullable()->index();
            $table->integer('gd4')->unsigned()->nullable()->index();
            $table->integer('gd5')->unsigned()->nullable()->index();
            $table->integer('gd6')->unsigned()->nullable()->index();
            $table->integer('gd7')->unsigned()->nullable()->index();
            $table->integer('gd8')->unsigned()->nullable()->index();
            $table->integer('gd9')->unsigned()->nullable()->index();
