...
class CreateGetInstitutionTypeProcedure extends Migration
{
    private $name = 'get_institution_type';
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        ...
        select institution_type into @x from sch_institution_type where sch_institution_type.id = id;
