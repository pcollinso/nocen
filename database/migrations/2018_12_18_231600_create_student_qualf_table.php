...
class CreateStudentQualfTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sch_student_qualf', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('gd1')->nullable()->unsigned()->index();
    ...
    {
        Schema::dropIfExists('sch_student_qualf');
    }
}
